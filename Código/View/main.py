...
import sys
# Controller class
from Código.Controller.Controller import MainController
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        create_graph_btn = QPushButton("Process Files")
        create_graph_btn.clicked.connect(self.process_files)
    ...
    # Function that process the selected files and URL
    def process_files(self):
        ...
        print(f"Items {items}")
        self.main_controller.addFiles(items)
